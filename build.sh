...
swiftc -O -swift-version 5 -target arm64-apple-macosx14.0 Sources/ImageCrop.swift Sources/LiveDesktop.swift Sources/Sensor.swift Sources/Renderer.swift Sources/main.swift -o build/HingeGlass.app/Contents/MacOS/HingeGlass -framework AppKit -framework MetalKit -framework ScreenCaptureKit -framework IOKit -framework Carbon
